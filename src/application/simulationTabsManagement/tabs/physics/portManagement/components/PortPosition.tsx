						...
						<div className="flex justify-around mt-2">
							<div className="w-[30%]">
								<input
									...
									type="number"
									step={0.1}
									value={selectedPort.inputElement.transformationParams.position[0].toFixed(
										6
									)}
									onChange={(event) => {
										let newPosition = [
							...
							<div className="w-[30%]">
								<input
									...
									type="number"
									step={0.1}
									value={selectedPort.inputElement.transformationParams.position[1].toFixed(
										6
									)}
									onChange={(event) => {
										let newPosition = [
							...
							<div className="w-[30%]">
								<input
									...
									type="number"
									step={0.1}
									value={selectedPort.inputElement.transformationParams.position[2].toFixed(
										6
									)}
									onChange={(event) => {
										let newPosition = [
						...
						<div className="flex justify-around mt-2">
							<div className="w-[30%]">
								<input
									...
									type="number"
									step={0.1}
									value={selectedPort.outputElement.transformationParams.position[0].toFixed(
										6
									)}
									onChange={(event) => {
										let newPosition = [
							...
							<div className="w-[30%]">
								<input
									...
									type="number"
									step={0.1}
									value={selectedPort.outputElement.transformationParams.position[1].toFixed(
										6
									)}
									onChange={(event) => {
										let newPosition = [
							...
							<div className="w-[30%]">
								<input
									...
									type="number"
									step={0.1}
									value={selectedPort.outputElement.transformationParams.position[2].toFixed(
										6
									)}
									onChange={(event) => {
										let newPosition = [
