...
import {
    ...
    selectFolder,
    selectProject, sharedElementsFolderSelector
...
const MySharedElements: React.FC<MySharedElementsProps> = (
    ...
    const [pathSharedElements, setPathSharedElements] = useState([mainSharedFolder]);
                                ...
                                <div className="inline-block ml-2" key={index}>
                                    {index !== pathSharedElements.length - 1 ? (
										...
										<span
                                            ...
                                            onClick={() => {
                                                let newPath = pathSharedElements.filter((p, i) => i <= index);
                        ...
                        (projects.length > 0 || folders.length > 0) ? (
                            <>
                                <div className="flex flex-wrap ">
                                    {folders.length > 0 && <h5 className="w-[100%]">Shared Folders</h5>}
                                    {folders.map((folder) => {
                                        return (
